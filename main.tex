...
gate catches information gaps and not knowledge errors: across $\sim$33{,}000 episodes, five models
and nine evaluation sets, discrimination is strong where insufficiency dominates---interactive
...
The manipulation is effective in every cell and its magnitude is graded by how much the removal
costs. On MedCalc, where the removed value makes the calculation unanswerable, accuracy falls by
